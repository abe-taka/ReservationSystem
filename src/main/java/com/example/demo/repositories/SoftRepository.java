...
public interface SoftRepository extends JpaRepository<SoftEntity,String>{
	...
	@Query(value = "SELECT DISTINCT z.m07_soft_code,z.m07_maker,z.m07_soft_name FROM m06_machine x,m08_machine_soft y,m07_soft z WHERE x.m06_floor = :floor AND x.m06_machine_code = y.m08_machine_code AND y.m08_soft_code = z.m07_soft_code", nativeQuery = true)
